...
--
-- Host: localhost    Database: dbelaseguradov4
-- ------------------------------------------------------
-- Server version	8.0.18
create schema dbelaseguradov4;
use dbelaseguradov4;
...
--
-- Table structure for table `aniodevehiculo`
--

DROP TABLE IF EXISTS `aniodevehiculo`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `aniodevehiculo` (
  `idAnioDeVehiculo` int(11) NOT NULL AUTO_INCREMENT,
  `anio` year(4) DEFAULT NULL,
  PRIMARY KEY (`idAnioDeVehiculo`)
) ENGINE=InnoDB AUTO_INCREMENT=24 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `aniodevehiculo`
--

LOCK TABLES `aniodevehiculo` WRITE;
/*!40000 ALTER TABLE `aniodevehiculo` DISABLE KEYS */;
INSERT INTO `aniodevehiculo` VALUES (1,1970),(2,1980),(3,1995),(4,2000),(5,2001),(6,2002),(7,2003),(8,2004),(9,2005),(10,2006),(11,2007),(12,2008),(13,2009),(14,2010),(15,2011),(16,2012),(17,2013),(18,2014),(19,2015),(20,2016),(21,2017),(22,2018),(23,2019);
/*!40000 ALTER TABLE `aniodevehiculo` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `aniomodelo`
--

DROP TABLE IF EXISTS `aniomodelo`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `aniomodelo` (
  `idAnioModelo` int(11) NOT NULL,
  `idModelo` int(11) NOT NULL,
  `idAnioDeVehiculo` int(11) NOT NULL,
  PRIMARY KEY (`idAnioModelo`,`idModelo`,`idAnioDeVehiculo`),
  KEY `fk_idMod` (`idModelo`),
  KEY `fk_idAnioDeVeh` (`idAnioDeVehiculo`),
  CONSTRAINT `fk_idAnioDeVeh` FOREIGN KEY (`idAnioDeVehiculo`) REFERENCES `aniodevehiculo` (`idAnioDeVehiculo`),
  CONSTRAINT `fk_idMod` FOREIGN KEY (`idModelo`) REFERENCES `modelo` (`idModelo`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `aniomodelo`
--

LOCK TABLES `aniomodelo` WRITE;
/*!40000 ALTER TABLE `aniomodelo` DISABLE KEYS */;
INSERT INTO `aniomodelo` VALUES (1,1,4),(2,1,6),(3,1,8),(4,2,4),(5,2,6),(6,2,9),(7,2,10),(8,3,4),(9,3,14),(10,3,19),(11,4,1),(12,4,2),(13,4,4),(14,5,12),(15,5,13),(16,5,14),(17,5,16),(18,6,18),(19,6,20),(20,6,23),(21,7,1),(22,7,2),(23,8,1),(24,8,2),(25,9,4),(26,9,12),(27,9,13),(28,10,15),(29,10,19),(30,11,19),(31,11,23),(32,12,22),(33,12,23),(34,13,4),(35,13,11),(36,13,14),(37,14,8),(38,14,9),(39,15,10),(40,15,12),(41,16,1),(42,16,4),(43,17,2),(44,17,3),(45,18,4);
/*!40000 ALTER TABLE `aniomodelo` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `cliente` (
  ...
  `idCondicionIVA` int(11) DEFAULT NULL,
  `idTipoDeDocumento` int(11) DEFAULT NULL,
  `idEstadoCliente` int(11) DEFAULT NULL,
  `nombre` varchar(50) DEFAULT NULL,
  `apellido` varchar(50) DEFAULT NULL,
  `nroDocumento` int(8) DEFAULT NULL,
  `correoElectronico` char(50) DEFAULT NULL,
  `anioDeRegistro` year(4) DEFAULT NULL,
  `nroCuil` bigint(11) DEFAULT NULL,
  `nroCliente` bigint(11) DEFAULT NULL,
  PRIMARY KEY (`idCliente`),
  KEY `fk_idEstadoCivil` (`idEstadoCivil`),
  KEY `fk_idProfesion` (`idProfesion`),
  KEY `fk_idDireccion` (`idDireccion`),
  KEY `fk_idCondicionIVA` (`idCondicionIVA`),
  KEY `fk_idTipoDeDocumento` (`idTipoDeDocumento`),
  KEY `fk_idEstadoCliente` (`idEstadoCliente`),
  CONSTRAINT `fk_idCondicionIVA` FOREIGN KEY (`idCondicionIVA`) REFERENCES `condicioniva` (`idCondicionIVA`),
  ...
  CONSTRAINT `fk_idEstadoCliente` FOREIGN KEY (`idEstadoCliente`) REFERENCES `estadocliente` (`idEstadoCliente`),
  CONSTRAINT `fk_idProfesion` FOREIGN KEY (`idProfesion`) REFERENCES `profesion` (`idProfesion`),
  CONSTRAINT `fk_idTipoDeDocumento` FOREIGN KEY (`idTipoDeDocumento`) REFERENCES `tipodedocumento` (`idTipoDeDocumento`)
...
INSERT INTO `cliente` VALUES (1,2,207,1,2,1,1,'ANA MARIA','ALVAREZ',23000111,'anamaria111@gmail.com',2018,27230001112,155555551),(2,1,4,10,1,2,2,'BRUNO','BATISTELLA',23000222,'brunobatistella111@gmail.com',2017,27230002223,155555552),(3,3,10,4,4,7,2,'JUAN','PEREZ',34567825,'juanperez@hotmail.com',2016,27345678255,155555553),(4,4,11,5,3,4,2,'PEDRO','BOTTA',12378945,'pedro_botta@hotmail.com',2013,27123789450,155555554),(5,1,6,8,14,1,1,'MIRTA','LEGRAND',12361245,'rosa_legrand@gmail.com',2014,27123612453,155555555),(6,6,4,9,3,1,1,'SUSANA','TORIO',17854631,'susan@yahoo.com',2007,27178546311,155555556),(7,7,7,7,5,1,2,'MILAGROS','HICISTE',38456782,'milagrosh@hotmail.com',2010,27384567820,155555557),(8,5,8,6,7,3,1,'TOMÁS','SCHNEIDER',18385789,'tomas_scheneider@gmail.com',2018,27183857892,155555558),(9,4,9,3,9,4,2,'HELEN','CHUFFE',25159878,'helen.c@gmail.com',2005,27251598780,155555559),(10,1,2,2,12,6,1,'LOLA','MENTO',35485896,'lolamentamos@hotmail.com',2008,27354858963,155555560);
...
CREATE TABLE `cuota` (
  ...
  `cuotasPagas` int(11) DEFAULT NULL,
  `vencimiento` date DEFAULT NULL,
  `valorOriginal` float DEFAULT NULL,
  `valorPorMora` float DEFAULT NULL,
  `valorTotalaPagar` float DEFAULT NULL,
  `bonificacion` float DEFAULT NULL,
  `recargoPorMora` float DEFAULT NULL,
  PRIMARY KEY (`idCuotas`),
  KEY `fk_idRecibo` (`idRecibo`),
  CONSTRAINT `fk_idRecibo` FOREIGN KEY (`idRecibo`) REFERENCES `recibo` (`idRecibo`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Table structure for table `datosdehijo`
--

DROP TABLE IF EXISTS `datosdehijo`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `datosdehijo` (
  `idDatosHijo` int(11) NOT NULL AUTO_INCREMENT,
  `idEstadoCivil` int(11) DEFAULT NULL,
  `fecha` date DEFAULT NULL,
  `sexo` char(9) DEFAULT NULL,
  `porcentaje` float DEFAULT NULL,
  PRIMARY KEY (`idDatosHijo`),
  KEY `fk_idEstadoCiv` (`idEstadoCivil`),
  CONSTRAINT `fk_idEstadoCiv` FOREIGN KEY (`idEstadoCivil`) REFERENCES `estadocivil` (`idEstadoCivil`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `datosdehijo`
--

LOCK TABLES `datosdehijo` WRITE;
/*!40000 ALTER TABLE `datosdehijo` DISABLE KEYS */;
/*!40000 ALTER TABLE `datosdehijo` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `direccion` VALUES (1,22,'San Martin',3333,2,'2A'),(2,12,'Misiones',4444,0,'A'),(3,1,'25 de Mayo',111,1,'1A'),(4,4,'9 de Julio',2945,7,'7C'),(5,5,'Boulevard',123,6,'6B'),(6,6,'Monte Caseros',328,NULL,NULL),(7,7,'1 de Mayo',1713,NULL,NULL),(8,9,'Pasaje Ola',456,3,'3A'),(9,8,'Francia',1256,NULL,NULL),(10,2,'Urquiza',789,NULL,NULL);
...
INSERT INTO `estado` VALUES (1,'NORMAL'),(2,'PLATA');
...
INSERT INTO `estadocivil` VALUES (1,'Soltero/a.'),(2,'Comprometido/a.'),(3,'Casado/a.'),(4,'Unión libre o unión de hecho.'),(5,'Separado/a.'),(6,'Divorciado/a.'),(7,'Viudo/a.');
...
LOCK TABLES `estadocliente` WRITE;
/*!40000 ALTER TABLE `estadocliente` DISABLE KEYS */;
INSERT INTO `estadocliente` VALUES (1,'NORMAL'),(2,'PLATA');
/*!40000 ALTER TABLE `estadocliente` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `factoresusados`
--

DROP TABLE IF EXISTS `factoresusados`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `factoresusados` (
  `idFacUsados` int(11) NOT NULL AUTO_INCREMENT,
  `idMedPorc` int(11) NOT NULL,
  `porcentajeCobertura` float DEFAULT NULL,
  `porcentajePorRiesgoDeDomicilio` float DEFAULT NULL,
  `porcentajePorKm` float DEFAULT NULL,
  `porcentajePorModeloVehiculo` float DEFAULT NULL,
  `porcentajePorMedidasDeSeguridad` float DEFAULT NULL,
  `porcentajePorSiniestro` float DEFAULT NULL,
  `porcentajePorHijo` float DEFAULT NULL,
  `importePorDescuentosPagoSemestral` float DEFAULT NULL,
  `descuentoPorUnidad` float DEFAULT NULL,
  `montoTotal` float DEFAULT NULL,
  `prima` float DEFAULT NULL,
  PRIMARY KEY (`idFacUsados`),
  KEY `fk_idMedidasPorc` (`idMedPorc`),
  CONSTRAINT `fk_idMedidasPorc` FOREIGN KEY (`idMedPorc`) REFERENCES `medidasdeseguridadporc` (`idMedPorc`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `factoresusados`
--

LOCK TABLES `factoresusados` WRITE;
/*!40000 ALTER TABLE `factoresusados` DISABLE KEYS */;
/*!40000 ALTER TABLE `factoresusados` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `formasdepago` VALUES (1,'Efectivo'),(2,'Debito'),(3,'Crédito'),(4,'Transferencia Bancaria'),(5,'Pagaré'),(6,'Cheque'),(7,'Sobre Factura'),(8,'Giro Bancario');
/*!40000 ALTER TABLE `formasdepago` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `kmporanio`
--

DROP TABLE IF EXISTS `kmporanio`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `kmporanio` (
  `idKmPorAnio` int(11) NOT NULL AUTO_INCREMENT,
  `porcentaje` float DEFAULT NULL,
  PRIMARY KEY (`idKmPorAnio`)
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `kmporanio`
--

LOCK TABLES `kmporanio` WRITE;
/*!40000 ALTER TABLE `kmporanio` DISABLE KEYS */;
INSERT INTO `kmporanio` VALUES (1,30),(2,40),(3,35),(4,37),(5,32);
/*!40000 ALTER TABLE `kmporanio` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `marca` VALUES (1,'Audi'),(2,'Chevrolet'),(3,'Citroen'),(4,'Ferrari'),(5,'Ford'),(6,'Fiat'),(7,'Peugeot'),(8,'Renault'),(9,'Rolls-Royce'),(10,'Toyota');
/*!40000 ALTER TABLE `marca` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `medidasdeseguridad`
--

DROP TABLE IF EXISTS `medidasdeseguridad`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `medidasdeseguridad` (
  `idMedidasSeguridad` int(11) NOT NULL AUTO_INCREMENT,
  `idMedPorc` int(11) NOT NULL,
  `nombre` char(50) DEFAULT NULL,
  `porcentaje` float DEFAULT NULL,
  PRIMARY KEY (`idMedidasSeguridad`),
  KEY `fk_idMedPorc` (`idMedPorc`),
  CONSTRAINT `fk_idMedPorc` FOREIGN KEY (`idMedPorc`) REFERENCES `medidasdeseguridadporc` (`idMedPorc`)
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `medidasdeseguridad`
--

LOCK TABLES `medidasdeseguridad` WRITE;
/*!40000 ALTER TABLE `medidasdeseguridad` DISABLE KEYS */;
INSERT INTO `medidasdeseguridad` VALUES (1,1,'	¿Se guarda en garage?',60),(2,2,'	¿Posee dispositivo de rastreo vehicular?',50),(3,3,'	¿Tiene alarma?',30),(4,2,'	¿Posee tuercas antirrobo en las cuatro ruedas?',40);
/*!40000 ALTER TABLE `medidasdeseguridad` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `medidasdeseguridadporc`
--

DROP TABLE IF EXISTS `medidasdeseguridadporc`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `medidasdeseguridadporc` (
  `idMedPorc` int(11) NOT NULL AUTO_INCREMENT,
  `porcentaje` float DEFAULT NULL,
  PRIMARY KEY (`idMedPorc`)
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `medidasdeseguridadporc`
--

LOCK TABLES `medidasdeseguridadporc` WRITE;
/*!40000 ALTER TABLE `medidasdeseguridadporc` DISABLE KEYS */;
INSERT INTO `medidasdeseguridadporc` VALUES (1,40),(2,55),(3,63);
/*!40000 ALTER TABLE `medidasdeseguridadporc` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `modelo` (
  ...
  `porcentaje` float DEFAULT NULL,
  `modelocol` char(40) DEFAULT NULL,
...
INSERT INTO `modelo` VALUES (1,1,'A4',38,NULL),(2,1,'A6',35,NULL),(3,2,'Camaro',30,NULL),(4,2,'Malibu',40,NULL),(5,3,'C4 Sedan',32,NULL),(6,3,'C3 Picasso',41,NULL),(7,4,'Avenger',31,NULL),(8,4,'Nitro',25,NULL),(9,5,'Focus',45,NULL),(10,5,'Fiesta',42,NULL),(11,6,'Punto',43,NULL),(12,6,'Tipo',30,NULL),(13,7,'Partner',31,NULL),(14,8,'Clio',41,NULL),(15,8,'Laguna',43,NULL),(16,9,'Touring',38,NULL),(17,10,'Supra',32,NULL),(18,10,'Carina E',36,NULL);
/*!40000 ALTER TABLE `modelo` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `modificacionpoliza`
--

DROP TABLE IF EXISTS `modificacionpoliza`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `modificacionpoliza` (
  `idModificacionPoliza` int(11) NOT NULL AUTO_INCREMENT,
  `idVehiculo` int(11) NOT NULL,
  `idMedidasSeguridad` int(11) NOT NULL,
  `idDatosHijo` int(11) NOT NULL,
  `idTipoCobertura` int(11) NOT NULL,
  `identNroPoliza` int(11) NOT NULL,
  `anio` year(4) DEFAULT NULL,
  `patente` char(10) DEFAULT NULL,
  `motor` char(20) DEFAULT NULL,
  `chasis` char(20) DEFAULT NULL,
  `nroSiniestro` char(10) DEFAULT NULL,
  `kmPorAnio` int(11) DEFAULT NULL,
  `montoTotal` float DEFAULT NULL,
  PRIMARY KEY (`idModificacionPoliza`),
  KEY `fk_idVeh` (`idVehiculo`),
  KEY `fk_idMedidasSeguridad` (`idMedidasSeguridad`),
  KEY `fk_idDatHijo` (`idDatosHijo`),
  KEY `fk_idTipoCob` (`idTipoCobertura`),
  KEY `fk_identNroPol` (`identNroPoliza`),
  CONSTRAINT `fk_idDatHijo` FOREIGN KEY (`idDatosHijo`) REFERENCES `datosdehijo` (`idDatosHijo`),
  CONSTRAINT `fk_idMedidasSeguridad` FOREIGN KEY (`idMedidasSeguridad`) REFERENCES `medidasdeseguridad` (`idMedidasSeguridad`),
  CONSTRAINT `fk_idTipoCob` FOREIGN KEY (`idTipoCobertura`) REFERENCES `tipocobertura` (`idTipoCobertura`),
  CONSTRAINT `fk_idVeh` FOREIGN KEY (`idVehiculo`) REFERENCES `vehiculo` (`idVehiculo`),
  CONSTRAINT `fk_identNroPol` FOREIGN KEY (`identNroPoliza`) REFERENCES `poliza` (`identNroPoliza`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `modificacionpoliza`
--

LOCK TABLES `modificacionpoliza` WRITE;
/*!40000 ALTER TABLE `modificacionpoliza` DISABLE KEYS */;
/*!40000 ALTER TABLE `modificacionpoliza` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `numeropoliza`
--

DROP TABLE IF EXISTS `numeropoliza`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `numeropoliza` (
  `nroPoliza` int(11) NOT NULL AUTO_INCREMENT,
  `nroSucursal` int(4) NOT NULL,
  `aleatorio` int(7) NOT NULL,
...
--
-- Dumping data for table `numeropoliza`
--

LOCK TABLES `numeropoliza` WRITE;
/*!40000 ALTER TABLE `numeropoliza` DISABLE KEYS */;
/*!40000 ALTER TABLE `numeropoliza` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `parametrosgenerales` (
  `idParametrosGenerales` int(11) NOT NULL AUTO_INCREMENT,
  `derechosDeEmision` float DEFAULT NULL,
  `tasaDeInteres` float DEFAULT NULL,
  `tasaDeDescuento` float DEFAULT NULL,
  PRIMARY KEY (`idParametrosGenerales`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `poliza` (
  `identNroPoliza` int(11) NOT NULL AUTO_INCREMENT,
  `idCliente` int(11) DEFAULT NULL,
  `idKmPorAnio` int(11) DEFAULT NULL,
  `idMedidasSeguridad` int(11) DEFAULT NULL,
  `idEstado` int(11) DEFAULT NULL,
  `idEstadoCliente` int(11) DEFAULT NULL,
  `nroPoliza` int(11) DEFAULT NULL,
  `idVehiculo` int(11) DEFAULT NULL,
  `idParametrosGenerales` int(11) DEFAULT NULL,
  `idFormasDePago` int(11) DEFAULT NULL,
  `idTipoCobertura` int(11) DEFAULT NULL,
  `idCuotas` int(11) DEFAULT NULL,
  `idDatosHijo` int(11) DEFAULT NULL,
  `idFacUsados` int(11) DEFAULT NULL,
  `idSiniestro` int(11) DEFAULT NULL,
  `fechaInicioVigencia` date DEFAULT NULL,
  `fechaFinVigencia` date DEFAULT NULL,
  `sumaAsegurada` float(6,2) DEFAULT NULL,
  `nroSiniestro` char(1) DEFAULT NULL,
  `cantidad` int(11) DEFAULT NULL,
  PRIMARY KEY (`identNroPoliza`),
  KEY `fk_idCliente` (`idCliente`),
  KEY `fk_idKmPorAnio` (`idKmPorAnio`),
  KEY `fk_idMedidasDeSeguridad` (`idMedidasSeguridad`),
  KEY `fk_idEstado` (`idEstado`),
  KEY `fk_nroPoliza` (`nroPoliza`),
  KEY `fk_idVehiculo` (`idVehiculo`),
  KEY `fk_idParametrosGenerales` (`idParametrosGenerales`),
  KEY `fk_idFormasDePago` (`idFormasDePago`),
  KEY `fk_idCuotas` (`idCuotas`),
  KEY `fk_idDatosHijo` (`idDatosHijo`),
  KEY `fk_idTipoCobertura` (`idTipoCobertura`),
  KEY `fk_idFacUsados` (`idFacUsados`),
  KEY `fk_idSiniestro` (`idSiniestro`),
  CONSTRAINT `fk_idCliente` FOREIGN KEY (`idCliente`) REFERENCES `cliente` (`idCliente`),
  CONSTRAINT `fk_idCuotas` FOREIGN KEY (`idCuotas`) REFERENCES `cuota` (`idCuotas`),
  CONSTRAINT `fk_idDatosHijo` FOREIGN KEY (`idDatosHijo`) REFERENCES `datosdehijo` (`idDatosHijo`),
  CONSTRAINT `fk_idEstado` FOREIGN KEY (`idEstado`) REFERENCES `estado` (`idEstado`),
  CONSTRAINT `fk_idFacUsados` FOREIGN KEY (`idFacUsados`) REFERENCES `factoresusados` (`idFacUsados`),
  CONSTRAINT `fk_idFormasDePago` FOREIGN KEY (`idFormasDePago`) REFERENCES `formasdepago` (`idFormasDePago`),
  CONSTRAINT `fk_idKmPorAnio` FOREIGN KEY (`idKmPorAnio`) REFERENCES `kmporanio` (`idKmPorAnio`),
  CONSTRAINT `fk_idMedidasDeSeguridad` FOREIGN KEY (`idMedidasSeguridad`) REFERENCES `medidasdeseguridad` (`idMedidasSeguridad`),
  CONSTRAINT `fk_idParametrosGenerales` FOREIGN KEY (`idParametrosGenerales`) REFERENCES `parametrosgenerales` (`idParametrosGenerales`),
  CONSTRAINT `fk_idSiniestro` FOREIGN KEY (`idSiniestro`) REFERENCES `siniestro` (`idSiniestro`),
  CONSTRAINT `fk_idTipoCobertura` FOREIGN KEY (`idTipoCobertura`) REFERENCES `tipocobertura` (`idTipoCobertura`),
  CONSTRAINT `fk_idVehiculo` FOREIGN KEY (`idVehiculo`) REFERENCES `vehiculo` (`idVehiculo`),
  CONSTRAINT `fk_nroPoliza` FOREIGN KEY (`nroPoliza`) REFERENCES `numeropoliza` (`nroPoliza`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `profesion` VALUES (1,'Abogado/Abogada'),(2,'Académico/Académica'),(3,'Adjunto/Adjunta'),(4,'Administrador/Administradora'),(5,'Administrativo/Administrativa'),(6,'Agrónomo/Agrónoma'),(7,'Alergólogo/Alergista'),(8,'Alergóloga/Alergista'),(9,'Almacenero/Almacenista'),(10,'Almacenera/Almacenista'),(11,'Anatomista/Anatomista'),(12,'Anestesiólogo/Anestesista'),(13,'Anestesióloga/Anestesista'),(14,'Antologista/Antologista'),(15,'Antropólogo/Antropóloga'),(16,'Arabista/Arabista'),(17,'Archivero/Archivera'),(18,'Arqueólogo/Arqueóloga'),(19,'Arquitecto/Arquitecta'),(20,'Asesor/Asesora'),(21,'Asistente/Asistenta'),(22,'Astrofísico/Astrofísica'),(23,'Astrólogo/Astróloga'),(24,'Astrónomo/Astrónoma'),(25,'Atleta'),(26,'ATS'),(27,'Autor/Autora'),(28,'Auxiliar/Auxiliar'),(29,'Avicultor/Avicultora'),(30,'Bacteriólogo/Bacterióloga'),(31,'Bedel/Bedela'),(32,'Bibliógrafo/Bibliógrafa'),(33,'Bibliotecario/Bibliotecaria'),(34,'Biofísico/Biofísica'),(35,'Biógrafo/Biógrafa'),(36,'Biólogo/Bióloga'),(37,'Bioquímico/Bioquímica'),(38,'Botánico/Botánica'),(39,'Cancerólogo/Canceróloga'),(40,'Cardiólogo/Cardióloga'),(41,'Cartógrafo/Cartógrafa'),(42,'Castrador/Castradora'),(43,'Catedrático/Catedrática'),(44,'Cirujano/Cirujana'),(45,'Citólogo/Citóloga'),(46,'Climatólogo/Climatóloga'),(47,'Codirector/Codirectora'),(48,'Comadrón/Comadrona'),(49,'Consejero/Consejera'),(50,'Conserje/Conserje'),(51,'Conservador/Conservadora'),(52,'Coordinador/Coordinadora'),(53,'Cosmógrafo/Cosmógrafa'),(54,'Cosmólogo/Cosmóloga'),(55,'Criminalista/Criminalista'),(56,'Cronólogo/Cronóloga'),(57,'Decano/Decana'),(58,'Decorador/Decoradora'),(59,'Defensor/Defensora'),(60,'Delegado/Delegada'),(61,'Delineante/Delineante'),(62,'Demógrafo/Demógrafa'),(63,'Dentista'),(64,'Dermatólogo/Dermatóloga'),(65,'Dibujante'),(66,'Directivo/Directiva'),(67,'Director/Directora'),(68,'Dirigente'),(69,'Doctor/Doctora'),(70,'Documentalista'),(71,'Ecólogo/Ecóloga'),(72,'Economista/Economista'),(73,'Educador/Educadora'),(74,'Egiptólogo/Egiptóloga'),(75,'Endocrinólogo/Endocrinóloga'),(76,'Enfermero/Enfermera'),(77,'Enólogo/Enóloga'),(78,'Entomólogo/Entomóloga'),(79,'Epidemiólogo/Epidemióloga'),(80,'Especialista'),(81,'Espeleólogo/Espeleóloga'),(82,'Estadista'),(83,'Estadístico/Estadística'),(84,'Etimologista'),(85,'Etnógrafo/Etnógrafa'),(86,'Etnólogo/Etnóloga'),(87,'Etólogo/Etóloga'),(88,'Examinador/Examinadora'),(89,'Facultativo/Facultativa'),(90,'Farmacéutico/Farmacéutica'),(91,'Farmacólogo/Farmacóloga'),(92,'Filólogo/Filóloga'),(93,'Filósofo/Filósofa'),(94,'Fiscal'),(95,'Físico/Física'),(96,'Fisiólogo/Fisióloga'),(97,'Fisioterapeuta'),(98,'Fonetista'),(99,'Foníatra'),(100,'Fonólogo/Fonóloga'),(101,'Forense'),(102,'Fotógrafo/Fotógrafa'),(103,'Funcionario/Funcionaria'),(104,'Gemólogo/Gemóloga'),(105,'Genetista'),(106,'Geobotánica'),(107,'Geodesta'),(108,'Geofísico/Geofísica'),(109,'Geógrafo/Geógrafa'),(110,'Geólogo/Geóloga'),(111,'Geomántico/Geomántica'),(112,'Geómetra'),(113,'Geoquímica'),(114,'Gerente/Gerenta'),(115,'Geriatra'),(116,'Gerontólogo/Gerontóloga'),(117,'Gestor/Gestora'),(118,'Grabador/Grabadora'),(119,'Graduado social/Graduada social'),(120,'Grafólogo/Grafóloga'),(121,'Gramático/Gramática'),(122,'Hematólogo/Hematóloga'),(123,'Hepatólogo/Hepatóloga'),(124,'Hidrogeólogo/Hidrogeóloga'),(125,'Hidrógrafo/Hidrógrafa'),(126,'Hidrólogo/Hidróloga'),(127,'Higienista/Higienista'),(128,'Hispanista'),(129,'Historiador/Historiadora'),(130,'Homeópata'),(131,'Informático/Informática'),(132,'Ingeniero/Ingeniera'),(133,'Ingeniero técnico/Ingeniera técnica'),(134,'Inmunólogo/Inmunóloga'),(135,'Inspector/Inspectora'),(136,'Interino/Interina'),(137,'Interventor/Interventora'),(138,'Investigador/Investigadora'),(139,'Jardinero/Jardinera'),(140,'Jefe/Jefa'),(141,'Juez/Jueza'),(142,'Latinista/Latinista'),(143,'Lector/Lectora'),(144,'Letrado (abogado)/Letrada (abogada)'),(145,'Lexicógrafo/Lexicógrafa'),(146,'Lexicólogo/Lexicóloga'),(147,'Licenciado/Licenciada'),(148,'Lingüista'),(149,'Logopeda'),(150,'Maestro/Maestra'),(151,'Matemático/Matemática'),(152,'Matrón/Matrona'),(153,'Médico/Médica'),(154,'Meteorólogo/Meteoróloga'),(155,'Micólogo/Micóloga'),(156,'Microbiológico/Microbiológica'),(157,'Microcirujano/Microcirujana'),(158,'Mimógrafo/Mimógrafa'),(159,'Mineralogista'),(160,'Monitor/Monitora'),(161,'Músico/Música'),(162,'Musicólogo/Musicóloga'),(163,'Naturópata/Naturópata'),(164,'Nefrólogo/Nefróloga'),(165,'Neumólogo/Neumóloga'),(166,'Neuroanatomista'),(167,'Neurobiólogo/Neurobióloga'),(168,'Neurocirujano/Neurocirujana'),(169,'Neuroembriólogo/Neuroembrióloga'),(170,'Neurofisiólogo/Neurofisióloga'),(171,'Neurólogo/Neuróloga'),(172,'Nutrólogo/Nutróloga'),(173,'Oceanógrafo,Oceanógrafa'),(174,'Odontólogo,Odontóloga'),(175,'Oficial/Oficiala'),(176,'Oficinista'),(177,'Oftalmólogo/Oftalmóloga'),(178,'Oncólogo/Oncóloga'),(179,'Óptico/Óptica'),(180,'Optometrista'),(181,'Ordenanza'),(182,'Orientador/Orientadora'),(183,'Ornitólogo/Ornitóloga'),(184,'Ortopédico/Ortopédica'),(185,'Ortopedista'),(186,'Osteólogo/Osteóloga'),(187,'Osteópata'),(188,'Otorrinolaringólogo/a'),(189,'Paleobiólogo/Paleobióloga'),(190,'Paleobotánico/Paleobotánica'),(191,'Paleógrafo/Paleógrafa'),(192,'Paleólogo/Paleóloga'),(193,'Paleontólogo/Paleontóloga'),(194,'Patólogo/Patóloga'),(195,'Pedagogo/Pedagoga'),(196,'Pediatra'),(197,'Pedicuro/Pedicura'),(198,'Periodista'),(199,'Perito/Perita'),(200,'Piscicultor/Piscicultora'),(201,'Podólogo/Podóloga'),(202,'Portero/Portera'),(203,'Prehistoriador/Prehistoriadota'),(204,'Presidente/Presidenta'),(205,'Proctólogo/Proctóloga'),(206,'Profesor/Profesora'),(207,'Programador/Programadora'),(208,'Protésico/Protésica'),(209,'Proveedor/Proveedora'),(210,'Psicoanalista/Psicoanalista'),(211,'Psicólogo/Psicóloga'),(212,'Psicofísico/Psicofísica'),(213,'Psicopedagogo/Psicopedagoga'),(214,'Psicoterapeuta'),(215,'Psiquiatra'),(216,'Publicista'),(217,'Publicitario/Publicitaria'),(218,'Puericultor/Puericultora'),(219,'Químico/Química'),(220,'Quiropráctico/Quiropráctica'),(221,'Radioastrónomo/Radioastrónoma'),(222,'Radiofonista'),(223,'Radiólogo/Radióloga'),(224,'Radiotécnico/Radiotécnica'),(225,'Radiotelefonista/Radiotelefonista'),(226,'Radiotelegrafista/Radiotelegrafista'),(227,'Radioterapeuta/Radioterapeuta'),(228,'Rector/Rectora'),(229,'Sanitario/Sanitaria'),(230,'Secretario/Secretaria'),(231,'Sexólogo/Sexóloga'),(232,'Sismólogo/Sismóloga'),(233,'Sociólogo/Socióloga'),(234,'Subdelegado/Subdelegada'),(235,'Subdirector/Subdirectora'),(236,'Subsecretario/Subsecretaria'),(237,'Técnico/Técnica'),(238,'Telefonista'),(239,'Teólogo/Teóloga'),(240,'Terapeuta'),(241,'Tocoginecólogo/Tocoginecóloga'),(242,'Tocólogo/Tocóloga'),(243,'Toxicólogo/Toxicóloga'),(244,'Traductor/Traductora'),(245,'Transcriptor/Transcriptora'),(246,'Traumatólogo/Traumatóloga'),(247,'Tutor/Tutora'),(248,'Urólogo/Uróloga'),(249,'Veterinario/Veterinaria'),(250,'Vicedecano/Vicedecana'),(251,'Vicedirector/Vicedirectora'),(252,'Vicegerente'),(253,'Vicepresidente/Vicepresidenta'),(254,'Vicerrector/Vicerrectora'),(255,'Vicesecretario/Vicesecretaria'),(256,'Virólogo/Viróloga'),(257,'Viticultor/Viticultora'),(258,'Vulcanólogo/Vulcanóloga'),(259,'Xilógrafo/Xilógrafa'),(260,'Zoólogo/Zoóloga'),(261,'Zootécnico/Zootécnica'),(262,'Otros');
...
INSERT INTO `provincia` VALUES (1,1,'Buenos Aires'),(4,1,'Catamarca'),(5,1,'Chaco'),(6,1,'Chubut'),(7,1,'Córdoba'),(8,1,'Corrientes'),(9,1,'Entre Ríos'),(10,1,'Formosa'),(11,1,'Jujuy'),(12,1,'La Pampa'),(13,1,'La Rioja'),(14,1,'Mendoza'),(15,1,'Misiones'),(16,1,'Neuquén'),(17,1,'Río Negro'),(18,1,'Salta'),(19,1,'San Juan'),(20,1,'San Luis'),(21,1,'Santa Cruz'),(22,1,'Santa Fe'),(23,1,'Santiago del Estero'),(24,1,'Tierra del Fuego'),(25,1,'Tucumán');
...
CREATE TABLE `recibo` (
  ...
  `ultimoDiaDePago` date DEFAULT NULL,
  `importeTotal` float DEFAULT NULL,
  PRIMARY KEY (`idRecibo`),
  KEY `fk_idOperador` (`idOperador`),
  CONSTRAINT `fk_idOperador` FOREIGN KEY (`idOperador`) REFERENCES `operador` (`idOperador`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `tipocobertura` (
  `idTipoCobertura` int(11) NOT NULL AUTO_INCREMENT,
...
LOCK TABLES `tipocobertura` WRITE;
/*!40000 ALTER TABLE `tipocobertura` DISABLE KEYS */;
INSERT INTO `tipocobertura` VALUES (1,'Resp. Civil',35.5,'Cubre al conductor y a los pasajeros del otro automóvil, \nasí como también motociclistas, ciclistas o peatones a quienes el cliente dañe con su vehículo'),(2,'Resp. Civil, Robo o Incendio Total',80,'Cubre la\n Responsabilidad Civil hacia Terceros, más la cobertura Robo y/o Hurto, Incendio y \nDaños por accidente, en aquellos casos que el perjuicio para el automotor sea total.'),(3,'Todo Total',100,'Cubre los reclamos \nque pudiera recibir el asegurado o el conductor del automotor,\n como consecuencia de los daños causados a terceras personas (transportadas o no transportadas)\n o a sus bienes.'),(4,'Terceros Completos',90,'Cubre Responsabilidad Civil\n hacia Terceros, más la cobertura de Robo y/o Hurto e Incendio,\n en aquellos casos que el perjuicio para el vehículo sea parcial o total.\n En el caso de Daños por accidente, este seguro automotor cubre solamente\n la Destrucción Total del vehículo.'),(5,'Todo Riesgo con Franquicia',60,'Responsabilidad Civil hacia Terceros,\n más la cobertura de Robo y/o Hurto e Incendio,\n en aquellos casos que el perjuicio para el automotor sea parcial o total. \n En el caso de Daños por accidente, cubre tanto la Destrucción \n Total del automotor como los daños parciales, pero estos últimos,\npor encima de una franquicia deducible, \npor todo y cada evento, que queda a cargo del asegurado');
/*!40000 ALTER TABLE `tipocobertura` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `tipodedocumento` VALUES (1,'DNI'),(2,'L.E'),(3,'REG. UNICO DE CONTRIBUYENTES'),(4,'PASAPORTE'),(5,'CARNET DE EXTRANJERIA'),(6,'PART. DE NACIMIENTO-IDENTIDAD'),(7,'OTROS');
...
--
-- Dumping events for database 'dbelaseguradov4'
--

--
-- Dumping routines for database 'dbelaseguradov4'
--
...
-- Dump completed on 2020-01-18 20:56:56
