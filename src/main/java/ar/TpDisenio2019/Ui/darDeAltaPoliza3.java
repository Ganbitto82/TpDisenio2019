...
public class darDeAltaPoliza3 extends JFrame {
	...
	public darDeAltaPoliza3(DTOCliente dtoCliente, DTOPoliza dtoPoliza, DTOVehiculo dtoVehiculo,
			DTOMedidasdeseguridad dtoMedidasSeguridad, DTOCuota dtoCuota) {
		...
		panel_2.setBorder(
				new TitledBorder(null, "TITULAR DEL SEGURO", TitledBorder.LEADING, TitledBorder.TOP, null, null));

		JPanel panel_3 = new JPanel();
		panel_3.setBounds(5, 191, 829, 148);
		panel_3.setBorder(
				new TitledBorder(null, "DATOS DEL VEH\u00CDCULO", TitledBorder.LEADING, TitledBorder.TOP, null, null));
		...
		gl_panel_3.setHorizontalGroup(gl_panel_3.createParallelGroup(Alignment.LEADING).addGroup(gl_panel_3
				...
				.addGroup(gl_panel_3.createParallelGroup(Alignment.TRAILING)
						.addGroup(gl_panel_3.createSequentialGroup().addComponent(lblMarca).addGap(18).addComponent(
								textField_marca, GroupLayout.PREFERRED_SIZE, 135, GroupLayout.PREFERRED_SIZE))
						.addGroup(gl_panel_3.createParallelGroup(Alignment.TRAILING, false)
								.addGroup(gl_panel_3.createSequentialGroup().addComponent(lblMotor)
										.addPreferredGap(ComponentPlacement.RELATED, GroupLayout.DEFAULT_SIZE,
												Short.MAX_VALUE)
										.addComponent(textField_motor, GroupLayout.PREFERRED_SIZE, 135,
												GroupLayout.PREFERRED_SIZE))
								.addGroup(gl_panel_3.createSequentialGroup().addComponent(lblChasis).addGap(18)
										.addComponent(textField_chasis, GroupLayout.PREFERRED_SIZE, 135,
												GroupLayout.PREFERRED_SIZE))))
				.addGap(122)
				.addGroup(
						gl_panel_3.createParallelGroup(Alignment.LEADING, false)
								.addGroup(gl_panel_3.createSequentialGroup().addComponent(lblModelo)
										.addPreferredGap(ComponentPlacement.RELATED, GroupLayout.DEFAULT_SIZE,
												Short.MAX_VALUE)
										.addComponent(textField_modelo, GroupLayout.PREFERRED_SIZE, 135,
												GroupLayout.PREFERRED_SIZE))
								.addGroup(gl_panel_3.createSequentialGroup().addComponent(lblPatente).addGap(18)
										.addComponent(textField_patente, GroupLayout.PREFERRED_SIZE, 135,
												GroupLayout.PREFERRED_SIZE)))
		...
		gl_panel_3.setVerticalGroup(gl_panel_3.createParallelGroup(Alignment.LEADING).addGroup(gl_panel_3
				...
				.addGroup(gl_panel_3.createParallelGroup(Alignment.LEADING)
						.addGroup(gl_panel_3.createSequentialGroup()
								.addGroup(gl_panel_3.createParallelGroup(Alignment.BASELINE).addComponent(lblModelo)
										.addComponent(textField_modelo, GroupLayout.PREFERRED_SIZE,
												GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE))
								.addPreferredGap(ComponentPlacement.UNRELATED)
								.addGroup(gl_panel_3.createParallelGroup(Alignment.BASELINE).addComponent(lblPatente)
										.addComponent(textField_patente, GroupLayout.PREFERRED_SIZE,
												GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE)))
						.addGroup(gl_panel_3.createSequentialGroup()
								.addGroup(gl_panel_3.createParallelGroup(Alignment.BASELINE)
										.addComponent(textField_marca, GroupLayout.PREFERRED_SIZE,
												GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE)
										.addComponent(lblMarca))
								.addPreferredGap(ComponentPlacement.UNRELATED)
								.addGroup(gl_panel_3.createParallelGroup(Alignment.BASELINE).addComponent(lblChasis)
										.addComponent(textField_chasis, GroupLayout.PREFERRED_SIZE,
												GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE))
								.addPreferredGap(ComponentPlacement.UNRELATED)
								.addGroup(gl_panel_3.createParallelGroup(Alignment.BASELINE)
										.addComponent(textField_motor, GroupLayout.PREFERRED_SIZE,
												GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE)
		...
		gl_panel_4.setHorizontalGroup(gl_panel_4.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_panel_4.createSequentialGroup().addGap(96).addComponent(lblFechaDeIniv).addGap(18)
						.addComponent(textField_7, GroupLayout.PREFERRED_SIZE, 135, GroupLayout.PREFERRED_SIZE)
						.addGap(101).addComponent(lblFechaDeFin).addGap(18)
		...
		gl_panel_4.setVerticalGroup(gl_panel_4.createParallelGroup(Alignment.TRAILING)
				.addGroup(gl_panel_4.createSequentialGroup().addContainerGap(34, Short.MAX_VALUE)
						.addGroup(gl_panel_4.createParallelGroup(Alignment.BASELINE).addComponent(lblFechaDeFin)
								.addComponent(textField_8, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE,
										GroupLayout.PREFERRED_SIZE)
								.addComponent(lblFechaDeIniv).addComponent(textField_7, GroupLayout.PREFERRED_SIZE,
										GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE))
						.addGap(25)));
		...
		gl_panel_5
				.setHorizontalGroup(gl_panel_5.createParallelGroup(Alignment.TRAILING)
						.addGroup(gl_panel_5
								.createSequentialGroup()
								.addGroup(gl_panel_5
										.createParallelGroup(Alignment.TRAILING)
										.addGroup(gl_panel_5.createSequentialGroup().addContainerGap()
												.addComponent(lblMontoTotalA).addGap(18)
												.addComponent(nombre_textField3, GroupLayout.PREFERRED_SIZE, 135,
														GroupLayout.PREFERRED_SIZE))
										.addGroup(gl_panel_5.createSequentialGroup().addGap(70).addGroup(gl_panel_5
												.createParallelGroup(Alignment.LEADING)
												.addGroup(gl_panel_5.createSequentialGroup().addGap(9).addComponent(
														lblSumaAsegurada, GroupLayout.PREFERRED_SIZE, 99,
														GroupLayout.PREFERRED_SIZE))
												.addComponent(lblImpPorDescuento, GroupLayout.DEFAULT_SIZE, 108,
														Short.MAX_VALUE))
												.addGap(18)
												.addGroup(gl_panel_5.createParallelGroup(Alignment.LEADING)
														.addComponent(textField_sumaAsegurada,
																GroupLayout.PREFERRED_SIZE, 135,
																GroupLayout.PREFERRED_SIZE)
														.addComponent(nombre_textField1, GroupLayout.PREFERRED_SIZE,
																135, GroupLayout.PREFERRED_SIZE))))
								.addGap(70)
								.addGroup(gl_panel_5.createParallelGroup(Alignment.TRAILING).addComponent(lblltimoDaDe)
										.addComponent(lblPremio))
								.addGap(18)
								.addGroup(gl_panel_5.createParallelGroup(Alignment.LEADING)
										.addComponent(nombre_textField0, GroupLayout.PREFERRED_SIZE, 135,
												GroupLayout.PREFERRED_SIZE)
										.addComponent(nombre_textField2, GroupLayout.PREFERRED_SIZE, 135,
												GroupLayout.PREFERRED_SIZE))
								.addGap(241))
						.addGroup(gl_panel_5.createSequentialGroup().addContainerGap(470, Short.MAX_VALUE)
		...
		gl_panel_5.setVerticalGroup(gl_panel_5.createParallelGroup(Alignment.LEADING).addGroup(gl_panel_5
				...
				.addGroup(gl_panel_5.createParallelGroup(Alignment.LEADING).addGroup(gl_panel_5
						...
						.addGroup(gl_panel_5.createParallelGroup(Alignment.BASELINE)
								.addComponent(nombre_textField0, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE,
										GroupLayout.PREFERRED_SIZE)
								.addComponent(lblPremio))
						.addGap(18)
						.addGroup(gl_panel_5.createParallelGroup(Alignment.BASELINE).addComponent(lblltimoDaDe)
								.addComponent(nombre_textField2, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE,
										GroupLayout.PREFERRED_SIZE)))
						.addGroup(
								gl_panel_5.createSequentialGroup()
										.addGroup(gl_panel_5.createParallelGroup(Alignment.BASELINE)
												.addComponent(lblSumaAsegurada)
												.addComponent(textField_sumaAsegurada, GroupLayout.PREFERRED_SIZE,
														GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE))
										.addGap(18)
										.addGroup(gl_panel_5.createParallelGroup(Alignment.BASELINE)
										...
										.addGap(71)
										.addGroup(gl_panel_5.createParallelGroup(Alignment.BASELINE)
												.addComponent(nombre_textField3, GroupLayout.PREFERRED_SIZE,
														GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE)
												.addComponent(lblMontoTotalA))))
				.addPreferredGap(ComponentPlacement.RELATED, 22, Short.MAX_VALUE).addGroup(gl_panel_5
		...
		gl_panel_2.setHorizontalGroup(gl_panel_2.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_panel_2.createSequentialGroup().addGroup(gl_panel_2.createParallelGroup(Alignment.LEADING)
						...
						.addGroup(gl_panel_2.createSequentialGroup().addGap(127).addComponent(lblApellido).addGap(18)
								.addComponent(apellido_textField, GroupLayout.PREFERRED_SIZE, 135,
										GroupLayout.PREFERRED_SIZE)
								.addGap(124).addComponent(lblNombre).addGap(18).addComponent(nombre_textField,
										GroupLayout.PREFERRED_SIZE, 135, GroupLayout.PREFERRED_SIZE)))
						.addContainerGap(135, Short.MAX_VALUE)));
		gl_panel_2.setVerticalGroup(gl_panel_2.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_panel_2.createSequentialGroup().addContainerGap().addComponent(label_1)
						.addPreferredGap(ComponentPlacement.UNRELATED)
						.addGroup(gl_panel_2.createParallelGroup(Alignment.BASELINE).addComponent(lblNombre)
								.addComponent(nombre_textField, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE,
										GroupLayout.PREFERRED_SIZE)
								.addComponent(lblApellido).addComponent(apellido_textField, GroupLayout.PREFERRED_SIZE,
										GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE))
		...
		gl_panel.setHorizontalGroup(gl_panel.createParallelGroup(Alignment.LEADING).addGap(0, 774, Short.MAX_VALUE)
				.addGap(0, 770, Short.MAX_VALUE).addGroup(gl_panel.createSequentialGroup().addGap(314)
						.addComponent(label).addContainerGap(299, Short.MAX_VALUE)));
		gl_panel.setVerticalGroup(gl_panel.createParallelGroup(Alignment.TRAILING).addGap(0, 87, Short.MAX_VALUE)
				.addGap(0, 83, Short.MAX_VALUE).addGroup(gl_panel.createSequentialGroup()
						.addContainerGap(33, Short.MAX_VALUE).addComponent(label).addGap(25)));
