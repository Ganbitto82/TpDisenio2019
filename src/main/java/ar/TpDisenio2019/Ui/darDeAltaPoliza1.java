...
public class darDeAltaPoliza1 extends JFrame {
	...
	public darDeAltaPoliza1(DTOCliente dtocliente, DTOPoliza dtoPoliza, DTOVehiculo dtoVehiculo,
		...
		panel_1.setBorder(
				new TitledBorder(null, "TIPOS DE COBERTURAS", TitledBorder.LEADING, TitledBorder.TOP, null, null));
		...
		panel_4.setBorder(new TitledBorder(
				...
				"COMPLETE LOS SIGUIENTES DATOS", TitledBorder.LEADING, TitledBorder.TOP, null, new Color(0, 0, 0)));
		...
		gl_panel_3.setHorizontalGroup(gl_panel_3.createParallelGroup(Alignment.TRAILING).addGroup(gl_panel_3
				.createSequentialGroup().addGap(43).addComponent(lblCamposObligatorios)
				.addPreferredGap(ComponentPlacement.RELATED, 445, Short.MAX_VALUE).addComponent(confirmar).addGap(18)
				.addComponent(btnCancelar, GroupLayout.PREFERRED_SIZE, 89, GroupLayout.PREFERRED_SIZE).addGap(32))
		...
		gl_panel_3.setVerticalGroup(gl_panel_3.createParallelGroup(Alignment.TRAILING)
				.addGroup(gl_panel_3.createSequentialGroup()
						...
						.addGroup(gl_panel_3.createParallelGroup(Alignment.TRAILING)
								.addGroup(gl_panel_3.createParallelGroup(Alignment.BASELINE).addComponent(confirmar)
			...
			public void actionPerformed(ActionEvent e) {
				if (e.getSource() == confirmar) {
					...
					if (formaDePago.equals(" --Seleccione-- ") || tipoCobertura.equals(" --Seleccione-- ")) {
						...
						dispose();
						darDeAltaPoliza3 b = new darDeAltaPoliza3(dtocliente, dtoPoliza, dtoVehiculo,
		...
		gl_panel_1.setHorizontalGroup(
				gl_panel_1.createParallelGroup(Alignment.LEADING).addGroup(gl_panel_1.createSequentialGroup().addGap(18)
						.addComponent(panel_2, GroupLayout.DEFAULT_SIZE, 789, Short.MAX_VALUE).addContainerGap()));
		...
		gl_panel_2.setHorizontalGroup(
				gl_panel_2.createParallelGroup(Alignment.LEADING).addGroup(gl_panel_2.createSequentialGroup().addGap(27)
		...
		table = new JTable();
		table.setModel(new DefaultTableModel(new Object[][] { { "Responsabilidad Civil" },
				...
				{ null }, { null }, { null }, { null }, { null }, }, new String[] { "Coberturas" }));
		...
		gl_panel.setHorizontalGroup(gl_panel.createParallelGroup(Alignment.LEADING).addGap(0, 784, Short.MAX_VALUE)
				.addGroup(gl_panel.createSequentialGroup().addGap(314).addComponent(label).addContainerGap(309,
						Short.MAX_VALUE)));
		gl_panel.setVerticalGroup(
				gl_panel.createParallelGroup(Alignment.TRAILING).addGap(0, 83, Short.MAX_VALUE).addGroup(gl_panel
						.createSequentialGroup().addContainerGap(29, Short.MAX_VALUE).addComponent(label).addGap(25)));
