...
public class darDeAltaPoliza2 extends JFrame {
	...
	private JTextField textField_UltimodiaDePago;
	private int identNroPoliza = 1;
	private int idVehiculo = 1;
	private int idFacUsados = 1;
	private int idParametrosGenerales = 1;
	private int idModificacionPoliza = 1;

	public darDeAltaPoliza2(DTOCliente dtoCliente, DTOPoliza dtoPoliza, DTOVehiculo dtoVehiculo, DTOCuota dtoCuota,  DTOMedidasdeseguridad dtoMedidasSeguridad) {
		...
		textField_fechaInicio.setEditable(false);
		...
		textField_FechaFin.setEditable(false);
		...
		gl_panel_4.setHorizontalGroup(
			gl_panel_4.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_panel_4.createSequentialGroup()
					...
					.addGap(18)
					.addComponent(textField_fechaInicio, GroupLayout.PREFERRED_SIZE, 135, GroupLayout.PREFERRED_SIZE)
					.addGap(101)
					.addComponent(lblFechaDeFin)
					.addGap(18)
					.addComponent(textField_FechaFin, GroupLayout.PREFERRED_SIZE, 135, GroupLayout.PREFERRED_SIZE)
			...
			gl_panel_4.createParallelGroup(Alignment.TRAILING)
				.addGroup(gl_panel_4.createSequentialGroup()
					...
					.addGroup(gl_panel_4.createParallelGroup(Alignment.BASELINE)
						...
						.addComponent(lblFechaDeIniv)
						.addComponent(textField_fechaInicio, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE))
					.addGap(25))
		);
		...
		textField_UltimodiaDePago = new JTextField();
		textField_UltimodiaDePago.setEditable(false);
		textField_UltimodiaDePago.setColumns(10);
		...
		if(dtoPoliza != null)
		{
			...
			textField_marca.setText(dtoVehiculo.getModelo().getMarca().getMarca());
			textField_modelo.setText(dtoVehiculo.getModelo().getNombre());
			...
			textField_fechaInicio.setText(dtoPoliza.getFechaInicioVigencia().toString());
		...
		btnAceptar.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				/*	estadoCivil.setIdEstadoCivil(dtoPoliza.getDatosdehijo().getEstadocivil().getIdEstadoCivil());
					...
					datosHijos.setFecha(dtoPoliza.getDatosdehijo().getFecha());
					datosHijos.setIdDatosHijo(dtoPoliza.getDatosdehijo().getIdDatosHijo());
					datosHijos.setPorcentaje(dtoPoliza.getDatosdehijo().getPorcentaje());
					datosHijos.setSexo(dtoPoliza.getDatosdehijo().getSexo());
					
					medidasPorc.setIdMedPorc(dtoPoliza.getMedidasdeseguridad().getMedidasdeseguridadporc().getIdMedPorc());
					medidasPorc.setPorcentaje(dtoPoliza.getMedidasdeseguridad().getMedidasdeseguridadporc().getPorcentaje());
					
					medidas.setIdMedidasSeguridad(dtoPoliza.getMedidasdeseguridad().getIdMedidasSeguridad());
					medidas.setNombre(dtoPoliza.getMedidasdeseguridad().getNombre());
					medidas.setPorcentaje(dtoPoliza.getMedidasdeseguridad().getPorcentaje());
					medidas.setMedidasdeseguridadporc(medidasPorc);*/
					
					modelo.setIdModelo(dtoVehiculo.getModelo().getIdModelo());
					modelo.setPorcentaje(dtoVehiculo.getModelo().getPorcentaje());
					...
					kmxAnio.setPorcentaje(dtoPoliza.getKmporanio().getPorcentaje());	
					cliente.setIdCliente(dtoCliente.getIdCliente());
					
					formaDePago.setIdFormasDePago(dtoPoliza.getFormasdepago().getIdFormasDePago());
					formaDePago.setNombre(dtoPoliza.getFormasdepago().getNombre());
					
					cobertura.setIdTipoCobertura(dtoPoliza.getTipocobertura().getIdTipoCobertura());
					cobertura.setTipo(dtoPoliza.getTipocobertura().getTipo());
					cobertura.setPorcentaje(dtoPoliza.getTipocobertura().getPorcentaje());
					
					siniestro.setCantidad(dtoPoliza.getSiniestro().getCantidad());
					siniestro.setIdSiniestro(dtoPoliza.getSiniestro().getIdSiniestro());
					siniestro.setPorcentaje(dtoPoliza.getSiniestro().getPorcentaje());
					...
					//Date anio = Fechas.obtenerFechaActual();

					//modificacion.setChasis(dtoVehiculo.getChasis());					
					//modificacion.setKmPorAnio(kmxAnio.getPorcentaje());
					//modificacion.setMotor(dtoVehiculo.getMotor());
					//modificacion.setNroSiniestro(dtoPoliza.getNroSiniestro());
					//modificacion.setPatente(dtoVehiculo.getPatente());
					//modificacion.setPoliza(poliza);
					//modificacion.setTipocobertura(cobertura);
					//modificacion.setVehiculo(vehiculo);
					//modificacion.setAnio(anio);
					//modificacion.setDatosdehijo(datosdehijo);
					//modificacion.setIdModificacionPoliza(idModificacionPoliza);
					//modificacion.setMedidasdeseguridad(medidasdeseguridad);
					//modificacion.setMontoTotal(montoTotal);
					
				//	System.out.println(".................................");
				//	System.out.println(modificacion.getIdModificacionPoliza());
				//	System.out.println(modificacion.getPoliza().getIdentNroPoliza());
			...
			gl_panel_5.createParallelGroup(Alignment.TRAILING)
				.addGroup(gl_panel_5.createSequentialGroup()
					...
					.addGroup(gl_panel_5.createParallelGroup(Alignment.LEADING)
						...
						.addComponent(textField_UltimodiaDePago, GroupLayout.PREFERRED_SIZE, 135, GroupLayout.PREFERRED_SIZE))
					.addGap(241))
				.addGroup(gl_panel_5.createSequentialGroup()
				...
				.addGroup(gl_panel_5.createSequentialGroup()
					...
					.addGroup(gl_panel_5.createParallelGroup(Alignment.LEADING)
						.addGroup(gl_panel_5.createSequentialGroup()
							...
							.addGroup(gl_panel_5.createParallelGroup(Alignment.BASELINE)
								.addComponent(lblltimoDaDe)
								.addComponent(textField_UltimodiaDePago, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE)))
						.addGroup(gl_panel_5.createSequentialGroup()
							.addGroup(gl_panel_5.createParallelGroup(Alignment.BASELINE)
		...
		idVehiculo++;
		idFacUsados++;
		idParametrosGenerales++;
		idModificacionPoliza++;
	}
}
