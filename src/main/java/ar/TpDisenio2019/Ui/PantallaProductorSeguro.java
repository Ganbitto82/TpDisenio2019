...
public class PantallaProductorSeguro extends JFrame {
	...
	private void initialize() {
		...
		gl_encabezado.setHorizontalGroup(gl_encabezado.createParallelGroup(Alignment.LEADING).addGroup(gl_encabezado
				.createSequentialGroup().addGap(314).addComponent(label).addContainerGap(309, Short.MAX_VALUE)));
		gl_encabezado.setVerticalGroup(gl_encabezado.createParallelGroup(Alignment.TRAILING).addGroup(gl_encabezado
				.createSequentialGroup().addContainerGap(30, Short.MAX_VALUE).addComponent(label).addGap(25)));
		...
		btnAltaPoliza.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				if (e.getSource() == btnAltaPoliza) {
					...
					/*
					 * DTOVehiculo dtoVehiculo= null; DTOMedidasdeseguridad
					 * dtoMedidasSeguridad=null; DTOCuota dtoCuota=null;
					 */
