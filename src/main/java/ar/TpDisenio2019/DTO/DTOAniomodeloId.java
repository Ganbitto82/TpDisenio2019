 ...
 */
@Embeddable
public class DTOAniomodeloId implements java.io.Serializable {

	private int idAnioModelo;
	private int idModelo;
	private int idAnioDeVehiculo;

	public DTOAniomodeloId() {
	}

	public DTOAniomodeloId(int idAnioModelo, int idModelo, int idAnioDeVehiculo) {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof DTOAniomodeloId))
			return false;
		DTOAniomodeloId castOther = (DTOAniomodeloId) other;
