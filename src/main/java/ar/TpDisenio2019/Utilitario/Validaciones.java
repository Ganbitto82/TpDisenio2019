...
public class Validaciones {
	...
	public static boolean validarApellidoONombre(String apellidoONombre) {
		...
		Pattern p = Pattern
				.compile("\\x20|\\x27|\\x2D|\\x41|\\x42|\\x43|\\x44|\\x45|\\x46|\\x47|\\x48|\\x49|\\x4A|\\x4B|\\x4C"
	...
	// valorDelCampo no debe ser la cadena vacía; valorMáximoPermitido debe ser
	// mayor que 0
	...
	public static boolean validarNumeroDePoliza(String cadena) {
		try {
	...
	// fecha podría ser "dd/mm/aaaa", o con algún u algunos dígitos menos, excepto
	// la cadena " / / "
